...
This project was born from a specific challenge given by our teacher: "Make an app where there is only one button."
...
🎮 Gameplay
The Objective: You must catch (click) the button as it runs away from your mouse pointer.
...
For Developers (Open in Unity)
To explore the code and see how the button's "escape" and "decoy" logic works:
...
📂 Project Structure
Assets/Scripts: Contains the C# logic for the decoy system, button movement, and the countdown timer.
